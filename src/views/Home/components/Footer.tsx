...
const Footer = () => {
  ...
  return (
    <>
      ...
      <Wrapper>
        <Heading mb="24px" scale="xl" color="#373357">
          {t('Welcome to Nosta')}
        </Heading>
        <Text textAlign="center" color="#373357">
          {t('Connect your crypto wallet to start')}
        </Text>
        .<Text mb="24px" bold color="#373357">
          {t('No registration needed')}
        </Text>

        <Link external href="https://gol.finance/swap/" color="#ffffff">
          {t('Trade Now')}
        </Link>
